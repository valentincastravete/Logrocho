    ...
    <section class="container my-5">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-5 d-flex justify-content-start">
                <div class="dataTables_info" id="alternative-page-datatable_info" role="status" aria-live="polite">Mostrando registros del 1 al 20 de 78</div>
            </div>
            ...
            <div class="col-sm-12">
                <table id="basic-datatable" class="table table-hover dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">7</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">8</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">9</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">10</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">11</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">12</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">13</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">14</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">15</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">16</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">17</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">18</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">19</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
                        ...
                        <tr>
                            <td><a href="<?= getIndex() ?>pincho" class="text-decoration-none btn btn-light btn-outline-secondary">20</a></td>
                            <td class="w-10"><input class="w-100 form-control" type="text" name="nombre" id="nombre" value="Pincho de tortilla"></td>
                            <td class="w-50">
                                <select class="w-100 form-control" type="text" name="bar" id="bar">
                                    <option value="bar1">Bar 1</option>
