...
<head>
    ...
    <base href="<?php echo getHome(); ?>../view/">
...
<body class="d-flex flex-column">
    <header class="bg-success text-white navbar navbar-expand-xl navbar-dark d-flex align-items-center justify-content-center justify-content-xl-start px-3 px-xl-5 text-center fs-4">
        ...
        <ul class="navbar-nav col-12 col-xl-auto me-xl-auto mb-2 justify-content-center mb-md-0">
            <li class="nav-item"><a href="listado_bares.html" class="nav-link active px-3 py-2 mx-1">Bares</a></li>
            <li class="nav-item"><a href="listado_pinchos.html" class="nav-link px-3 py-2 mx-1">Pinchos</a></li>
            <li class="nav-item"><a href="listado_valoraciones.html" class="nav-link px-3 py-2 mx-1">Valoraciones</a></li>
            <li class="nav-item"><a href="listado_usuarios.html" class="nav-link px-3 py-2 ms-1">Usuarios</a></li>
        </ul>
        ...
        <div class="row">
            <div class="col-sm-12">
                <table id="basic-datatable" class="table table-hover dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>1</td>
                            <td>Edelweiss</td>
                            <td>Avenida de la playa, 3 bajo, 26009, Logroño, La Rioja</td>
                        ...
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>2</td>
                            <td>Rosales</td>
                            <td>Calle Doce Ligero de Artillería, 6 6 6, 26004, Logroño, La Rioja</td>
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon" title="Editar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                        ...
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>3</td>
                            <td>Asador Bar Orly</td>
                            <td>Calle Rey Pastor, S/N 0, 26005, Logroño, La Rioja</td>
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon" title="Editar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                        ...
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>4</td>
                            <td>JESUS GOMARA GIL</td>
                            <td>Duques de Nájera, 6 6-B, 26002, Logroño, La Rioja</td>
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon" title="Editar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                        ...
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>5</td>
                            <td>CARLOS PLAZA GIMÉNEZ</td>
                            <td>Estambrera, 32 BAJO(LOCAL-4), 26006, Logroño, La Rioja</td>
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon" title="Editar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                        ...
                        <tr onclick="document.location = 'ficha_bar.html';">
                            <td>6</td>
                            <td>JOSE ENRIQUE GONZALEZ GARCIA</td>
                            <td>Duques de Nájera, 96 BAJO, 26005, Logroño, La Rioja</td>
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon" title="Editar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
