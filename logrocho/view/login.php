    ...
    <main class="form-signin border border-2 border-dark-50 rounded-3">
        <form method="POST" action="index.php/login" class="m-5">
            ...
            <div class="form-floating">
                <input type="email" class="campo form-control" id="email" name="email" placeholder="name@example.com">
            ...
            <div class="form-floating">
                <input type="password" class="campo form-control" id="password" name="password" placeholder="Password" <?php #pattern="^\S*(?=\S{8,})(?=\S*[a-z])(?=\S*[A-Z])(?=\S*[\d])\S*$"?>>
            ...
            <p class="small m-4"><a class="btn-outline-primary" href="<?php echo getHome() . "recuperar_cuenta"; ?>">He olvidado la contraseña</a></p>
            <input class="w-100 btn btn-outline-success btn-light" type="submit" value="Iniciar sesión">
            <p class="mt-5">¿No tienes cuenta? <a class="btn-outline-primary" href="<?php echo getHome() . "registro"; ?>" class="text-blue-50 fw-bold">Registrarse</a></p>
        </form>
    </main>
